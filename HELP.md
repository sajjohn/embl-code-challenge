...
* The original package name 'com.embl.api.personservice.embl-person-service' is invalid and this project uses 'com.embl.api.personservice.emblpersonservice' instead.
